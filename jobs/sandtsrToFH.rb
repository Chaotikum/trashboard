...
SCHEDULER.every '15s', :first_in => 0 do |job|
  ...
  connectionSandStrFh = http.request(Net::HTTP::Get.new('/connection?from=707193&to=707200&product=B&providerName=sh'))
  ...
  send_event('sanstrToFh', {current: minutesToDepature})
end
